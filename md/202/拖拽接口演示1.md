...
<div id="dest_copy" ondragleave="dragLeave_handler(event)" ondrop="drop_handler(event);"
...
<div id="dest_move" ondrop="drop_handler(event);" ondragover="dragover_handler(event);"><strong>Move Drop Zone</strong>
</div>
